...
def process_data():
	path='C:/Users/lai/Desktop/Coursea-ML/code/ex4-NN back propagation/ex4data1.mat'
	X,y=load_data(path)
...
X,y=process_data()
path='C:/Users/lai/Desktop/Coursea-ML/code/ex4-NN back propagation/ex4weights.mat'
...
z2,a2,z3,a3=feed_forward(X,theta1,theta2)
cal_cost(y,a3)
print('ssss',z2.shape,' ',a2.shape,' ',z3.shape,' ',a3.shape,' ',y.shape)
